...
//                console.log("songlog: ", data.room.metadata.songlog);
...
cmbot.prototype.getMysqlClient = function() {
        ...
        try {
                ...
                console.log("Exception ending mysql: ", e);
        }
//        if (cmbot.mysql === false) {
                try {
                        ...
                        console.log("Exception getting mysql client: ", e);
                }
//        }
//        return mysql;
        return cmbot.mysql;
...
cmbot.prototype.commands = {
        ...
        'setlimit': {
                command: function(options) {
                        ...
                        var speak = false;
                        if (options.arg == '') {
                                text = "The set limit is " + (options.cmbot.settings.setlimit == 0 ? "unlimited" : options.cmbot.settings.setlimit) + ".";
                                ...
                                if(!user.mod) {
                                        ...
                                        options.cmbot.saveSettings();
                                        speak = true;
                                        text = "The set limit is now " + (parseInt(options.arg) == 0 ? "unlimited" : options.arg) + ".";
                                }
                        } else
...
cmbot.prototype.matchSongTags = function(songs, callback) {
        ...
        if (idx === false) {
                ...
                console.log("Getting tags for " + songs[idx].title + " by " + songs[idx].artist);
                cmbot.lastfm.getTags({
...
cmbot.prototype.selectNextSong = function() {
        var cmbot = this;
        console.log("Executing selectNextSong");
        if (cmbot.settings.tagLog.length == 0) {
                ...
                cmbot.bot.playlistAll(function(res) {
                        ...
                        var songs = [];
                        for (var i = 0; i < 10; i++) {
                                var idx = getRandomNumber(20, plLength);
                        ...
                        console.log("Calling matchSongTags with ", songs);
                        cmbot.matchSongTags(songs, function(songsWithTags) {
                                console.log("Got songs with tags: ", songsWithTags);
