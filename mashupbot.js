...
var mybot = new cmbot({
    ...
    autoload_modules: false, // If set to true, scans the modules_directory for any .js files and loads any custom commands/events they contain
    ...
    master_userid: ['4f50f403590ca262030050e7'], // Who runs the bot should have extra privileges. Put your userid here. Can be a single userid (a string) or an array of them.
    ffa: [], // Array of days of the week for free for all. Sunday = 0, Monday = 1, etc. Set to false for none.
     ...
     */
    messages: [
        'Welcome to mashup.fm! Let\'s play some tunes!'
    ],
